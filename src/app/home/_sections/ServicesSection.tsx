      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        >
          <div className='inline-flex items-center justify-center gap-3 md:gap-6'>
            ...
            />
            <span className='text-3xl sm:text-4xl md:text-6xl lg:text-5xl font-heading font-black uppercase tracking-[0.2em] text-red-light whitespace-normal sm:whitespace-nowrap'>
              HerLead Legacy
            </span>
            <motion.div
              initial={{ scaleX: 0 }}
