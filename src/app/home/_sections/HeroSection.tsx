  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        {/* Subtle Grid Accent */}
        <div className="absolute inset-0 opacity-[0.05] bg-[radial-gradient(var(--color-text)_1px,transparent_1px)] [background-size:40px_40px]" />
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">

        {/* Logo with Glow Aura */}
        <motion.div variants={itemVariants} className="hero-logo relative w-[85vw] md:w-[35vw] max-w-2xl mx-auto mb-8 md:mb-12 group">
        ...
        <div className="space-y-6">
          <motion.h1 variants={itemVariants} className="hero-heading flex flex-col items-center justify-center">
            <span className="text-2xl md:text-4xl lg:text-6xl font-heading font-black text-text leading-none tracking-tighter uppercase inline-block overflow-hidden">
              360° <span className="text-secondary italic">DIGITAL</span>
            </span>
            <span className="relative text-2xl md:text-4xl lg:text-6xl font-heading font-black text-primary leading-none tracking-[0.1em] md:tracking-[0.2em] uppercase mt-2">
              ELEVATION
      ...
      <motion.div
        ...
        className="absolute bottom-1/4 right-10 md:right-20 w-16 h-16 border border-secondary/20 rotate-45 hidden lg:block"
      />
