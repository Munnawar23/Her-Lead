  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        {/* Logo with Glow Aura */}
        <div className="hero-logo relative w-[45vw] md:w-[25vw] max-w-lg mx-auto mb-16 group">
        ...
        <div className="space-y-6">
          <h1 className="hero-heading flex flex-col items-center justify-center">
            <span className="text-4xl md:text-5xl lg:text-7xl font-heading font-black text-text leading-none tracking-tighter uppercase inline-block overflow-hidden">
              360° <span className="text-red-light italic">DIGITAL</span>
            </span>
            <span className="relative text-4xl md:text-5xl lg:text-7xl font-heading font-black text-primary leading-none tracking-[0.2em] uppercase mt-2">
              ELEVATION
              <span className="absolute -bottom-2 left-0 w-full h-1 bg-primary/30" />
            </span>
          </h1>

          <div className="hero-subheading flex items-center justify-center gap-4 pt-10">
            <div className="h-[1px] w-8 bg-text/20" />
            <p className="text-xs md:text-sm font-body font-black text-text uppercase tracking-[0.5em] whitespace-nowrap">
      ...
      <div className="scroll-indicator absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3">
        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-text/40">Explore</span>
        <div className="w-[1px] h-12 bg-linear-to-b from-text/40 to-transparent" />
      </div>
    </section>
  )
}
